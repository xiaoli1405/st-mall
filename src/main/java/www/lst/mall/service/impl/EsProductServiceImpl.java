...
import www.lst.mall.dao.EsProductDao;
import www.lst.mall.nosql.elasticsearch.document.EsProduct;
import www.lst.mall.nosql.elasticsearch.repository.EsProductRepository;
...
public class EsProductServiceImpl implements EsProductService {
    ...
    public int importAll() {
        List<EsProduct> esProductLists = productDao.getAllEsProductList(null);
        Iterable<EsProduct> esProductIterable = productRepository.saveAll(esProductLists);
